...
#list of functions needing to be called twice each: add2, sub2, mul2, div2, secs_to_hrs2, circle_area2, sphere_vol2, avg_two_vols2, tri_area2, right_align2, centre2, msg_box2
